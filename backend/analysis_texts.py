...
# Libellés des illustrations du lot 4 (illustrations.py, deuxième série)
ILLU["fr"].update({
    "pillar_names": {"env": "Environnement", "social": "Social", "gov": "Gouvernance"},
    "map_issue": "Enjeu", "map_strength": "Point d'appui", "map_none": "—",
    "chain_steps": ["Constat", "Pourquoi", "Conséquence", "Première action"],
    "ratios": {
        "co2_staff": "t CO2e par salarié", "co2_rev": "t CO2e par M€ de CA",
        "mwh_staff": "MWh par salarié", "departures": "départs sur l'exercice (estimation)",
        "training_total": "heures de formation au total", "csr_staff": "€ de budget RSE par salarié",
    },
    "filled": "{f} / {t} renseignés",
    "scope_missing": "Scope {n} : non mesuré",
    "scope_note": "Les scopes non mesurés sont signalés sans valeur : leur taille est inconnue.",
    "check": {
        "committee": "Comité de durabilité", "audit": "Vérification externe des données",
        "independence": "Indépendance du conseil", "board_mix": "Mixité du conseil",
        "integrity": "Incidents d'intégrité",
    },
    "check_yes": "oui", "check_no": "non", "check_na": "non renseigné",
    "check_incidents": "{n} déclaré(s)", "check_none": "aucun déclaré",
    "stake": {"local": "Achats locaux", "satisfaction": "Satisfaction client",
              "disabled": "Salariés en situation de handicap"},
    "months": "mois", "quick_win": "gain rapide",
    "mixboard_staff": "Femmes dans l'effectif", "mixboard_board": "Femmes au conseil",
    "mixboard_ref": "repère interne {rep} %",
    "quad_x": "Heures de formation par salarié", "quad_y": "Rotation du personnel (%)",
    "quad": {"bad_bad": "Cercle vicieux", "bad_good": "Forme mais ne retient pas",
             "good_bad": "Stable mais peu formée", "good_good": "Cercle vertueux"},
    "tl_today": "{y}\ndiagnostic", "tl_next": "{y}\nprochain exercice :\n{n} indicateurs à collecter",
    "tl_next_full": "{y}\nprochain exercice", "tl_target": "{y}\nhorizon des objectifs",
    "tl_issues": "{n} enjeux à traiter", "first_start": "Aujourd'hui", "first_end": "Jour 90",
    "cap_issue_map": "Enjeux et points d'appui repérés dans les données, par pilier",
    "cap_chain": "Premier enjeu du diagnostic : du constat à la première action",
    "cap_ratios": "Ratios calculés à partir des données déclarées",
    "cap_completeness": "Indicateurs renseignés sur les indicateurs suivis, par pilier",
    "cap_scopes": "Répartition des émissions mesurées par scope",
    "cap_checklist": "Dispositif de gouvernance de la durabilité, tel que déclaré",
    "cap_stake": "Indicateurs d'ancrage territorial et de relation aux parties prenantes",
    "cap_roadmap": "Feuille de route sur douze mois, par pilier",
    "cap_mixboard": "Part de femmes dans l'effectif et au conseil",
    "cap_quadrant": "Position de l'entreprise : rotation du personnel et effort de formation",
    "cap_timeline": "Calendrier : de l'exercice diagnostiqué à l'horizon des objectifs",
    "cap_first": "Les trois premières décisions, par ordre de priorité",
})
ILLU["en"].update({
    "pillar_names": {"env": "Environment", "social": "Social", "gov": "Governance"},
    "map_issue": "Issue", "map_strength": "Strength", "map_none": "—",
    "chain_steps": ["Finding", "Why", "Consequence", "First action"],
    "ratios": {
        "co2_staff": "t CO2e per employee", "co2_rev": "t CO2e per €M revenue",
        "mwh_staff": "MWh per employee", "departures": "departures over the year (estimate)",
        "training_total": "training hours in total", "csr_staff": "€ of CSR budget per employee",
    },
    "filled": "{f} / {t} reported",
    "scope_missing": "Scope {n}: not measured",
    "scope_note": "Unmeasured scopes are flagged without a value: their size is unknown.",
    "check": {
        "committee": "Sustainability committee", "audit": "External assurance of data",
        "independence": "Board independence", "board_mix": "Board gender balance",
        "integrity": "Integrity incidents",
    },
    "check_yes": "yes", "check_no": "no", "check_na": "not reported",
    "check_incidents": "{n} reported", "check_none": "none reported",
    "stake": {"local": "Local purchasing", "satisfaction": "Customer satisfaction",
              "disabled": "Employees with a disability"},
    "months": "months", "quick_win": "quick win",
    "mixboard_staff": "Women in the workforce", "mixboard_board": "Women on the board",
    "mixboard_ref": "internal benchmark {rep}%",
    "quad_x": "Training hours per employee", "quad_y": "Staff turnover (%)",
    "quad": {"bad_bad": "Vicious circle", "bad_good": "Trains but does not retain",
             "good_bad": "Stable but under-trained", "good_good": "Virtuous circle"},
    "tl_today": "{y}\ndiagnosis", "tl_next": "{y}\nnext year:\n{n} indicators to collect",
    "tl_next_full": "{y}\nnext year", "tl_target": "{y}\ntarget horizon",
    "tl_issues": "{n} issues to address", "first_start": "Today", "first_end": "Day 90",
    "cap_issue_map": "Issues and strengths identified in the data, by pillar",
    "cap_chain": "First issue of the diagnosis: from finding to first action",
    "cap_ratios": "Ratios computed from the reported data",
    "cap_completeness": "Reported indicators out of tracked indicators, by pillar",
    "cap_scopes": "Breakdown of measured emissions by scope",
    "cap_checklist": "Sustainability governance framework, as reported",
    "cap_stake": "Local roots and stakeholder indicators",
    "cap_roadmap": "Twelve-month roadmap, by pillar",
    "cap_mixboard": "Share of women in the workforce and on the board",
    "cap_quadrant": "The company's position: staff turnover and training effort",
    "cap_timeline": "Timeline: from the diagnosed year to the target horizon",
    "cap_first": "The first three decisions, in order of priority",
})
